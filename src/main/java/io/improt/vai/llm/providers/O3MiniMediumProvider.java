...
public class O3MiniMediumProvider extends OpenAICommons implements IModelProvider {

    public O3MiniMediumProvider() {
        super();
    }
    ...
    public String request(String model, String prompt, String userRequest, List<File> files) {
        ...
        System.out.println("o3 mini medium called");
        ...
        ChatCompletionCreateParams params = ChatCompletionCreateParams.builder()
                ...
                .addMessage(build)
                .model("o3-mini")
                .reasoningEffort(ChatCompletionReasoningEffort.MEDIUM).build();
